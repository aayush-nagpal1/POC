                ...
                <div  style = {{backgroundColor:"#f5f6fa",width:"100%",paddingBottom:'30px'}}>
                  ...
                  <div className='main_section' style={{marginTop:'17px',marginLeft:'70px'}}>
                    ...
                    <div className='Line' style={{marginLeft:'9%',marginRight:'12%'}}/>
                      ...
                      <center><button className='btn payout-button optimize-btt' onClick={this.handleCustomTransaction.bind(this)} style={{margin:'3%'}}>
                      <div>CUSTOM PAYMENT</div>
                      <div>
                        <i style = {{width: '26px',height: '18.3px'}} className='fas fa-arrow-right'></i>
                      </div>
                    </button>
                    
                      <button className='btn payout-button optimize-btt' onClick={this.handlePayment.bind(this)} style={{margin:'3%'}}>
                      <div>AGREE & PAY</div>
                      <div>
                        <i style = {{width: '26px',height: '18.3px'}} className='fas fa-arrow-right'></i>
                      </div>
